...
<div class="imitsDumpPhenotypeAttempts index large-9 medium-8 columns content">
    ...
    <h3><?= __('Imits Dump Phenotype Attempts') ?></h3>
    <table class="table data-table table-responsive" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col">id</th>
                <th scope="col">imits_phenotype_attempt_id</th>
                ...
                <th scope="col">phenotype_attempt_json</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($imitsDumpPhenotypeAttempts as $imitsDumpPhenotypeAttempt): ?>
            <tr>
                ...
                <td class="actions">
                    <?= '<span data-toggle="tooltip" title="View">'. $this->Html->link('<span class="pad-action-glyph glyphicon glyphicon-eye-open"></span>', ['action' => 'view', $imitsDumpPhenotypeAttempt->id],  array('escape' => false, 'class' => 'label label-primary action-pad')) . '</span>' ?>
                </td>
                <td><?= h($imitsDumpPhenotypeAttempt->phenotype_attempt_json) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
