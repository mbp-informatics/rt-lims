...
use App\Model\Entity\QcResequencing;
use Cake\ORM\Query;
...
class QcResequencingsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->allowEmpty('MGAL_sequence');

        $validator
            ->allowEmpty('blast_result');

        $validator
            ->allowEmpty('MGAL_id_location');

        $validator
            ->allowEmpty('MGAL_expected');
